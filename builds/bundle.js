...
/***/ function(module, exports, __webpack_require__) {
	...
	function main() {
	  ...
	  if (!_state.store.getState().gameOver) {
	    ...
	    var body = JSON.stringify({ initials: initials, grade: grade.current, time: +timer.toFixed(2), score: score });
	...
	function update(dt) {
	  ...
	  if (pause) {
	    ...
	    if (newchar === 'ENTER') {
	      ...
	      _state.store.dispatch((0, _state.forceOverlayActionCreator)({ mode: "input", text: text + newchar }));
	    }
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setPlayerNameAC = exports.forceOverlayActionCreator = exports.cleanupActionCreator = exports.updateActionCreator = exports.rotateActionCreator = exports.store = undefined;
	...
	var forceOverlayActionCreator = function forceOverlayActionCreator(text) {
	  return {
	    type: 'FORCEOVERLAY',
	    overlay: text
	  };
	...
	var setPlayerNameAC = function setPlayerNameAC(initials) {
	  return {
	    type: 'SETPLAYERNAME',
	    initials: initials
	  };
	...
	exports.cleanupActionCreator = cleanupActionCreator;
	exports.forceOverlayActionCreator = forceOverlayActionCreator;
	exports.setPlayerNameAC = setPlayerNameAC;
...
/***/ function(module, exports) {
	...
	var handleTextInput = function handleTextInput() {
	  var t = pressedLetter;
	  pressedLetter = '';
	  if (t == 13) {
	    return 'ENTER';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nextPiece = __webpack_require__(62);

	var _nextPiece2 = _interopRequireDefault(_nextPiece);

	var _score = __webpack_require__(63);

	var _score2 = _interopRequireDefault(_score);

	var _level = __webpack_require__(64);

	var _level2 = _interopRequireDefault(_level);

	var _grade = __webpack_require__(65);

	var _grade2 = _interopRequireDefault(_grade);

	var _lockDelayMeter = __webpack_require__(66);

	var _lockDelayMeter2 = _interopRequireDefault(_lockDelayMeter);

	var _textOverlay = __webpack_require__(67);
	...
	var GameView = (0, _react.createClass)({
	  contextTypes: {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'rightPane' },
	        _react2.default.createElement(_textOverlay2.default, null),
	      ...
	      var _loop2 = function _loop2(j) {
	        cellNodes.push(function () {
	          ...
	          cells.forEach(function (cell) {
	            if (cell[0] === i && cell[1] === j) data.type = type + 100;
	            data.active = true;
	          });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = (0, _react.createClass)({
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'timer' },
	      (0, _util.formatTime)(this.props.timer)
	    );
	  }
	});
...
/***/ function(module, exports) {
	...
	function formatTime(time) {
	  ...
	  var mins = String(Math.floor(time / 60));
	  var secs = String((time % 60).toFixed(2));
	  if (time % 60 < 10) return mins + ":0" + secs;else return mins + ":" + secs;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NextPiece = (0, _react.createClass)({
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
	    return this.props.piece != nextProps.piece;
	  },
	  render: function render() {
	    var cellNodes = [];
	    var cells = (0, _movement.updateCells)({ loc: [0, 1], orient: 0, type: this.props.piece });
	    var type = this.props.piece;

	    var _loop = function _loop(i) {
	      var _loop2 = function _loop2(j) {
	        cellNodes.push(function () {
	          var data = { active: true, type: -1, neighbors: {} };
	          cells.forEach(function (cell) {
	            if (cell[0] === i && cell[1] === j) data.type = type + 100;
	          });
	          return _react2.default.createElement(
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(NextPiece);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Score = (0, _react.createClass)({
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Level = (0, _react.createClass)({
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grade = (0, _react.createClass)({
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(Grade);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LockDelayMeter = (0, _react.createClass)({
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
	    return this.props.lockDelay != nextProps.lockDelay;
	  },
	  render: function render() {
	    return (//TODO: Make this behave as a meter.
	      _react2.default.createElement('div', { className: 'lockDelayMeter' })
	    );
	  }
	});

	exports.default = (0, _reactRedux.connect)(mapStateToProps)(LockDelayMeter);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextOverlay = (0, _react.createClass)({
	  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(TextOverlay);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(200);
