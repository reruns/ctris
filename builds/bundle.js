...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Provider = exports.Cell = exports.Grid = undefined;
	...
	var Grid = createClass({
	  computeCell: function computeCell(i, j) {
	  ...
	  render: function render() {
	    ...
	    for (var i = 0; i < 21; i++) {
	      for (var j = 0; j < 10; j++) {
	        var data = computeCell(i, j);
	        cellNodes.append(_react2.default.createElement(Cell, { active: data.active, type: data.type, neighbors: data.neighbors }));
	      }
	    }
